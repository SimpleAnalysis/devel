...
class ot_judge_base(WarehouseModel, EncryptModel, Base_to):
    ...
    plaintiff = Column(String(250), doc=u'原告, 多个属性以:分隔，多个人以 ; 区分', nullable=False)

    plaintiff_lawyers = Column(String(250), doc=u'原告律师, 格式:殷大丽:天津事务所;张志琳:天津事务所', nullable=False)

    defendant = Column(String(250), doc=u'被告, 多个属性以:分隔，多个人以 ; 区分', nullable=False)

    defendant_lawyers = Column(String(250), doc=u'被告律师, 格式:殷大丽:天津事务所;张志琳:天津事务所', nullable=False)
    ...
    # 状态
    status = Column(Integer(), doc=u'状态')
